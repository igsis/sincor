...
function findit() 
{
	...
	if (string)  // only call findText if there is a string or IE will have error
		...
		{	
			...
			test.innerHTML = "Localizado";
		}
		else
		{
			test.innerHTML = "N&atilde;o localizado";
			finds--;
		}
	}
...
// This part creates the instructions and the "find" button
	...
	+ '<input id="btn" type="button" value="Seguinte" onclick="findit();">'
	+ '</div>\n'
	+ '<div id="test"><br /></div>';
...
document.write('<input type="button" value="Localizar..."'
	+ ' onclick="show();">');
