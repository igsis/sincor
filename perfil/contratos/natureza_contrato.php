<?php 
$con = bancoMysqli();
$sql_natureza = "SELECT `id`, `natureza` FROM `natureza` ORDER BY natureza";
$query_natureza = mysqli_query($con,$sql_natureza);
			
$i = 0;		

while($natureza = mysqli_fetch_array($query_natureza))
{	
	$x[$i]['id'] = $natureza['id'];
	$x[$i]['natureza'] = $natureza['natureza'];
	$i++;					
}
$x['num'] = $i;				
...
<section id="list_items">
	<div class="container">
		...
		<div class="form-group">
			<div class="col-md-offset-1 col-md-3"><a href="?perfil=contratos&p=cadastro_natureza" class="btn btn-theme btn-block">Cadastrar</a></div>
